...
class CatalogTabTests(unittest.TestCase):
    ...
    def test_question_banks_tab_ui_copy(self) -> None:
        ...
        self.assertIn('data-live-bank="1"', html)
        self.assertIn('id="live-bank-scope"', html)
        self.assertIn('aria-label="Bank scope"', html)
        self.assertIn('<option value="course">Course Wide</option>', html)
        self.assertIn('id="live-bank-kind"', html)
        self.assertIn('aria-label="Kind"', html)
        self.assertIn('<option value="warmup">Warmup</option>', html)
        self.assertIn('id="live-bank-search"', html)
        self.assertIn('id="live-bank-browse"', html)
        self.assertIn('id="live-bank-edit"', html)
        self.assertIn(">Browse</button>", html)
        ...
        self.assertIn('data-save-toast="Saved to this course’s copy."', html)
        ...
        self.assertIn("/module-banks/", js)
        self.assertIn("mc-search", js)
        self.assertNotIn("bank-item.v1", js)
        self.assertNotIn("/components/question-banks", js)
