...
Load: `student-content.json`, `interaction-spec.json`, `feedback-spec.json`, `locks.json`, `content-builder/catalogue/contracts/student-content.schema.json`, `content-builder/scripts/student_fields.py`, `content-builder/README.md`, `.cursor/rules/content-builder-runtime.mdc`, `.cursor/rules/content-builder-interactions.mdc`, `.cursor/rules/content-builder-ownership.mdc`, `.cursor/rules/content-builder-review.mdc`, visual CSS in `content-builder/components/`.
