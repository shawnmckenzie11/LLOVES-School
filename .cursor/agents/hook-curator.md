...
Load: `lesson-brief.json`, `content-builder/catalogue/contracts/hook-proposals.schema.json`, `.cursor/rules/content-builder-source-integrity.mdc`, `.cursor/rules/content-builder-runtime.mdc`.
